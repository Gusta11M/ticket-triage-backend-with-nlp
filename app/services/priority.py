...
from app.schemas.priority import PriorityCreateSchema
...
async def get_priority_service(db:AsyncSession, priority_id:int) -> Priority | None:
...
async def update_priority_service(db:AsyncSession, priority_id:int, priority_data:PriorityCreateSchema) -> Priority | None:
